        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10 border-4 border-transparent bg-clip-padding relative overflow-hidden">
            ...
            <div className="relative">
              ...
              {/* CTA Button */}
              <button className="w-full bg-gradient-to-r from-red-600 via-purple-600 to-blue-600 text-white py-4 rounded-full font-semibold text-lg hover:shadow-lg transition-shadow">
                Buy Instantly
              </button>
